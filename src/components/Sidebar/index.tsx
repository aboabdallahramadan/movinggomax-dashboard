    ...
    menuItems: [
      ...
      // },
      {
        icon: (
          ...
          // >
          //   <path
          //     d="M19.7165 20.3624C19.3842 20.3624 19.1045 20.0827 19.1045 19.7504V14.8345C19.1045 14.5022 19.3842 14.2225 19.7165 14.2225C20.0488 14.2225 20.3285 14.5022 20.3285 14.8345V19.7504C20.3285 20.0827 20.0488 20.3624 19.7165 20.3624Z"
          //     fill=""
          //   />
          //   <path
          //     d="M21.5 18.5784H17.9331C17.6008 18.5784 17.3211 18.2987 17.3211 17.9664C17.3211 17.6341 17.6008 17.3544 17.9331 17.3544H21.5C21.8323 17.3544 22.112 17.6341 22.112 17.9664C22.112 18.2987 21.8323 18.5784 21.5 18.5784Z"
          //     fill=""
          //   />
          //   <path
          //     fillRule="evenodd"
          //     clipRule="evenodd"
          //     d="M14.0624 2.75H9.93717C6.4476 2.75 4.25 4.96574 4.25 8.49051V15.5095C4.25 19.0343 6.4476 21.25 9.93717 21.25H14.0624C17.552 21.25 19.7496 19.0343 19.7496 15.5095V8.49051C19.7496 4.96574 17.552 2.75 14.0624 2.75ZM9.93717 4.25C7.28139 4.25 5.75 5.79852 5.75 8.49051V15.5095C5.75 18.2015 7.28139 19.75 9.93717 19.75H14.0624C16.7182 19.75 18.2496 18.2015 18.2496 15.5095V8.49051C18.2496 5.79852 16.7182 4.25 14.0624 4.25H9.93717Z"
          //     fill=""
          //   />
          // </svg>
        ...
        route: "#",
        children: [
          { label: "Advertisement List", route: "/advertisements" },
          { label: "New Advertisement", route: "/advertisements/new" },
        ],
      }, {
        icon: (
          // <svg
        ...
        route: "#",
        children: [
          { label: "Notification List", route: "/notifications" },
          { label: "New Notification", route: "/notifications/new" },
        ],
      },
      {
        icon: (
          ...
          //     fillRule="evenodd"
          //     clipRule="evenodd"
          //     d="M11.9999 12.25C9.68634 12.25 7.55481 12.7759 5.97534 13.6643C4.41937 14.5396 3.24989 15.8661 3.24989 17.5L3.24982 17.602C3.24869 18.7638 3.24728 20.222 4.5263 21.2635C5.15577 21.7761 6.03637 22.1406 7.2261 22.3815C8.41915 22.6229 9.97412 22.75 11.9999 22.75C14.0257 22.75 15.5806 22.6229 16.7737 22.3815C17.9634 22.1406 18.844 21.7761 19.4735 21.2635C20.7525 20.222 20.7511 18.7638 20.75 17.602L20.7499 17.5C20.7499 15.8661 19.5804 14.5396 18.0244 13.6643C16.445 12.7759 14.3134 12.25 11.9999 12.25Z"
          //     fill=""
          //   />
          // </svg>
...

      {
        icon: (
          ...
          //     fillRule="evenodd"
          //     clipRule="evenodd"
          //     d="M12 1.25C11.2849 1.25 10.6233 1.44938 9.89927 1.78779C9.19742 2.11695 8.38715 2.60029 7.37173 3.20846L5.91514 4.07425C4.79145 4.74091 3.89838 5.27255 3.22404 5.78121C2.52773 6.30602 1.99774 6.84925 1.6586 7.56267C1.31704 8.28025 1.22601 9.03192 1.25649 9.90901C1.28613 10.7583 1.43421 11.7868 1.61938 13.0754L1.91218 15.1139C2.14994 16.7701 2.33887 18.0847 2.62068 19.1092C2.91127 20.1649 3.32496 21.0028 4.07165 21.6462C4.81773 22.2891 5.70937 22.5778 6.79841 22.7157C7.85604 22.8497 9.18934 22.8497 10.8725 22.8497H13.1275C14.8107 22.8497 16.144 22.8497 17.2016 22.7157C18.2906 22.5778 19.1823 22.2891 19.9284 21.6462C20.675 21.0028 21.0887 20.1649 21.3793 19.1092C21.6611 18.0847 21.8501 16.7701 22.0878 15.1139L22.3806 13.0754C22.5658 11.7868 22.7139 10.7583 22.7435 9.90901C22.774 9.03192 22.683 8.28025 22.3414 7.56267C22.0023 6.84925 21.4723 6.30602 20.776 5.78121C20.1016 5.27255 19.2085 4.74091 18.0849 4.07425L16.6283 3.20846C15.6129 2.60029 14.8026 2.11695 14.1007 1.78779C13.3767 1.44938 12.7151 1.25 12 1.25ZM8.10974 4.54039C9.1672 3.91062 9.91305 3.46736 10.5375 3.17601C11.1466 2.89161 11.5846 2.75 12 2.75C12.4154 2.75 12.8534 2.89161 13.4625 3.17601C14.087 3.46736 14.8328 3.91062 15.8903 4.54039L17.2762 5.36739C18.4403 6.06164 19.2619 6.55216 19.8647 7.00586C20.4529 7.44901 20.7753 7.81581 20.9748 8.23234C21.1742 8.64887 21.2572 9.12904 21.2323 9.86385C21.2067 10.6172 21.0722 11.5648 20.8801 12.9061L20.6009 14.8501C20.3543 16.5697 20.1778 17.7897 19.9247 18.7115C19.6773 19.6122 19.3795 20.1342 18.947 20.5087C18.514 20.8837 17.9524 21.1052 17.0214 21.2227C16.0699 21.3428 14.8322 21.3497 13.0893 21.3497H10.9107C9.16782 21.3497 7.93013 21.3428 6.97863 21.2227C6.04758 21.1052 5.486 20.8837 5.05297 20.5087C4.62055 20.1342 4.32274 19.6122 4.07526 18.7115C3.82225 17.7897 3.64566 16.5697 3.39908 14.8501L3.11991 12.9061C2.92782 11.5648 2.79333 10.6172 2.76775 9.86385C2.74279 9.12904 2.82576 8.64887 3.02524 8.23234C3.22473 7.81581 3.54711 7.44901 4.13534 7.00586C4.73812 6.55216 5.55968 6.06164 6.72385 5.36739L8.10974 4.54039Z"
          //     fill=""
          //   />
          // </svg>
      ...
      },
      {
        ...
        // ],
        children: [
          { label: "Warehousing Mission", route: "/missions/warehousing/new" },
          { label: "Transfer Mission", route: "/missions/transfer/new" },
          { label: "Cleaning Mission", route: "/missions/cleaning/new" },
          { label: "Car Empty Mission", route: "/missions/carEmpty/new" },
        ],
      },
      {
        icon: (
