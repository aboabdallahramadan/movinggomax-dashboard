...
export class MissionService {
  ...
  public async createCleaningMission(mission: CreateCleaningMissionModel): Promise<Mission> {
    Toast.fire({
        icon: "success",
...
public async createEmptyCarMission(mission: CreateEmptyCarMissionModel): Promise<Mission> {
    Toast.fire({
        icon: "success",
