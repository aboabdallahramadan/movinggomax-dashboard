...
const EmptyCarMissionDetails = ({ params }: { params: { id: string } }) => {
    ...
    return (
        <DefaultLayout>
            <Breadcrumb pageName="Empty Car Mission Details" />
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="rounded-2xl bg-white p-6 shadow-1 dark:bg-meta-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex flex-col">
                                        <span className="text-sm text-gray-500 dark:text-gray-400">Cars Available</span>
                                        <span className="text-lg font-semibold text-dark dark:text-white">{mission.NumberOfCarsAvailable}</span>
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-sm text-gray-500 dark:text-gray-400">Car Size</span>
                                        <span className="text-lg font-semibold text-dark dark:text-white">{mission.CarSize}</span>
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-sm text-gray-500 dark:text-gray-400">Type</span>
                                        <span className="text-lg font-semibold text-dark dark:text-white">
                                            {mission.IsLocal ? 'Local' : 'International'}
                                        </span>
                                    </div>
                                    <div className="flex flex-col">
